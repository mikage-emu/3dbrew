...
| Yes     | 0x10000000 | ?          | [IO](IO "wikilink") memory                                    |
...
| Yes     | 0x10000000 | 0x08000000 | [IO](IO "wikilink") memory                                                                                                            |
...
| 0x1EC00000              | 0x10100000                                                                    | 0x00400000                                                     | No                                            | [IO](IO "wikilink") registers, the mapped IO pages which each process can access is specified in the [exheader](NCCH/Extended_Header "wikilink"). (Applications normally don't have access to registers in this range)                                                                                                                                                                                                                                                |
...
| 0x1EC00000           | 0x10100000                                                                   | 0x00400000 | [IO](IO "wikilink")                                                                                       |
