...
| Application usage is to be recorded. If this is not set, it causes the application's usage to be omitted from the Home Menu's [icon cache](Home_Menu#Cache.dat_&_CacheD.dat "wikilink"), as well as in [other places](???????? "wikilink"). | 0x0100        |
