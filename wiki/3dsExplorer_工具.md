3DSExplorer 可以打开 3DS 的文件并且查看3DBrew解密的信息。

------------------------------------------------------------------------

**请使用最新版，我们已经修复了旧版本的一些bug。**

**请不要自行上传分享此工具，使用google code站点的链接就好了。**

------------------------------------------------------------------------

## 使用说明

工具需要*.NET Framework 4.0*'支持，可以从
[这里](http://www.microsoft.com/download/en/details.aspx?id=17851)获得

切记：如果你想安装此工具到Mac、Linux或者FreeBSD，需要安装的wine版本要高于15。

此工具在 Linux 下可以正常使用，但是不知Mac OS X上情形如何。
...
- [DARC](DARC "wikilink") (file containers) / [BCMA](BCMA "wikilink")
  CTR-Manuals
- Save Flash binaries ([SAV](Savegames "wikilink")) (解密或加密的)
- Title meta data 文件 ([TMD](TMD "wikilink")),
- Multi-Picture 对象 ([MPO](MPO "wikilink")) , (3D 图像)
...
把3ds/cci/csu文件打包为7z/zip (with any other file you want like nfo
file)

然后你就能用3dsexplorer打开它了。 **But be aware that only the first cxi
will be loaded and saving capabilities will not be available.**
...
你可以从[这里](http://3dsexplorer.googlecode.com/svn/trunk/3DSExplorer/bin/3DSExplorer.exe)获得工具最新版
，当然最新版可能会有bug。