...
\#searchInput.placeholder{color:#999}div#simpleSearch
...
a.loading{background-image:url('skins/Vector/images/watch-icon-loading.png');background-image:-webkit-linear-gradient(transparent,
transparent),/\* @embed \*/
